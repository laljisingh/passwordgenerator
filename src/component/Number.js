...
function Number({lengthkey,functionKey, message}){
    return(
        <div className="mb-6">
          <label htmlFor="length" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{message}</label>
